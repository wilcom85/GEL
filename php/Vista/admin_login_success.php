            ...
            <div id="page-wrapper">
                <nav>
                    <div class="menu">
                        ...
                        <li class="toplast"><a href="../Controlador/destruirSesion.php" style="width:140px;"><span><img src="../../img/1393565821_Log Out.png" alt="" width="50px"/>Salir</span></a>
                        </li>
                ...
                <article id="page-wrapper">
                    <iframe src= "<?php echo $_SESSION['$panel']; ?>"
                            name="AllInfo"
                            style="width:85%; height:410px; margin:5px;">
                    </iframe>
                </article>
            </div>
        <footer id="copyright">
